...
public class RingUserDetailPage {
	...
	//First Name
		...
		//mother's Name
		public static By objMothersName = By.xpath("(//*[@text='Last Name']/parent::android.view.ViewGroup/following-sibling::android.view.ViewGroup/descendant::android.widget.EditText)[1]");
	    ...
	    //Age less than 18 notification
	    public static By objAgeLessThan18Notification = By.xpath("//*[@text='Only Above 18 years allowed']");
